...
1. **Knapp, C., & Carter, G. (1976).** The generalized correlation method for estimation of time delay. *IEEE Trans. ASSP*, 24(4), 320-327.

2. **Benesty, J., et al. (2008).** Microphone Array Signal Processing. Springer.

3. **Doclo, S., & Moonen, M. (2003).** GSVD-based optimal filtering for single and multimicrophone speech enhancement. *IEEE Trans. Signal Process.*, 50(9), 2230-2244.
